/*
  ==============================================================================
    ...
    Project: Intelligent Lights and Sensor Mesh Network

    Description: Path guidance system using lamps and network of sensors using
    XBee Pro S2B radio modules. All data is sent to the Arduino that process it.
    A HTML page is generated by Arduino and it allows a user to send commands
    to the lamps - these are Philips Hue lights.

    Circuit: access Diagrams folder for more details
